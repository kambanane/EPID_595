...
# Reading in the data.
mich.crime <-
  read.table("Data/Michigan_crime_2006.csv",
             sep = ",",
             header = T)
...
plotvar <-  ## You have to fill in the response variable
  nclr <-  ## You have to choose the colors
...
plotvar <-   ## You have to fill this in
  nclr <-  ## You have to choose the number of colors
