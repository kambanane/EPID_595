...
hist(
  ...
  prob = T,
  col = "coral",
  xlab = "Average PM2.5 concentration",
  main = "Average PM2.5 concentration \n in California, February 2019",
  breaks = 30
)
...
# Here we create a vector of length 200 of regularly spaced longitudes and latitudes 
# spanning the range of longitudes and latitudes of the PM2.5 monitors.
...
image.plot(
  ...
  xlab = "Longitude",
  ylab = "Latitude",
  main = "Daily average PM2.5 concentration \n February 2019",
  xlim = c(-125, -114),
  ylim = c(32, 43)
)
...
# To run the variogram function, the user need to create first a dataframe containing 
